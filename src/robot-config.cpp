...
motor_group RightDriveSmart = motor_group(leftMotorB, leftMotorC);
motor rightMotorB = motor(PORT14, ratio18_1, false);
motor rightMotorC = motor(PORT11, ratio18_1, false);
motor_group LeftDriveSmart = motor_group(rightMotorB, rightMotorC);
